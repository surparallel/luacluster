...
---@class BigWorld
local bigworld= class()

bigworld.entities = {}
bigworld.split = 0;--测试分裂空间

--注册自己的entity id到redis
function bigworld:Init()
...
function bigworld:Update(count, deltaTime)
...
function bigworld:EntryWorld(id, poitionx, poitiony, poitionz, rotationx, rotationy, rotationz, velocity, stamp, stampStop)
...
--理论上这个对象不会被销毁
function bigworld:Destory()
    bigworldapi.Destroy()
end

function bigworld:SpaceFull(id)
--[[
...
--Init创建成功不做任何调整
function bigworld:OnSpace(id, oid, beginx, beginz, endx, endz)
