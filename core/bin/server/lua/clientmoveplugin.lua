...
---@class ClientMovePlugin
local clientMoveplugin = class()

clientMoveplugin.transform = {}
clientMoveplugin.transform.position = {}
clientMoveplugin.transform.nowPosition = {}
clientMoveplugin.transform.rotation = {}

function clientMoveplugin:UpdatePosition()
...
function clientMoveplugin:MoveTo(x, y, z)
